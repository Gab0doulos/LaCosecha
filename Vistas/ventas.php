                ...
                <div class="card shadow">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-12">
                                <h6 class="text-start fw-bold">Monto Efectivo: Q./ <span
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 text-right">
                                Q./ <span class="" id="boleta_nit">0.00</span>
                            </div>
...
$(document).ready(function() {
            ...
            success: function(respuesta) {
                ...
                if (parseInt(respuesta['existe']) == 0) {
                    ...
                    NuevoPrecio = (parseInt(data['cantidad']) * data[
                        'precio_venta_producto'].replace("Q./ ", "")).toFixed(2);
    ...
    $('#lstProductosVenta tbody').on('click', '.btnDisminuirCantidad', function() {
        ...
        if (data['cantidad'].replace('Und(s)', '') >= 2) {
            ...
            NuevoPrecio = (parseInt(data['cantidad']) * data['precio_venta_producto'].replace("Q./ ",
                "")).toFixed(2);
            NuevoPrecio = "Q./ " + NuevoPrecio;
...
function recalcularMontos(codigo_producto, precio_venta) {
    ...
    table.rows().eq(0).each(function(index) {
        ...
        if (data['codigo_producto'] == codigo_producto) {
            ...
            table.cell(index, 6).data("Q./ " + parseFloat(precio_venta).toFixed(2)).draw();

            // ACTUALIZAR EL NUEVO PRECIO DEL ITEM DEL LISTADO DE VENTA
            NuevoPrecio = (parseFloat(data['cantidad']) * data['precio_venta_producto'].replaceAll("Q./ ", ""))
                .toFixed(2);
            NuevoPrecio = "Q./ " + NuevoPrecio;
...
function recalcularTotales() {
    ...
    $("#boleta_nit").html(parseFloat(iva).toFixed(2));
            ...
            $.ajax({
                ...
                success: function(respuesta) {
                    ...
                    if (parseInt(respuesta['existe']) == 0) {
                        ...
                        // AUMENTAR EN 1 EL VALOR DE LA CANTIDAD
                        table.cell(index, 5).data(parseFloat(data['cantidad']) + 1 + ' Und(s)')
                            .draw();

                        // ACTUALIZAR EL NUEVO PRECIO DEL ITEM DEL LISTADO DE VENTA
                        NuevoPrecio = (parseInt(data['cantidad']) * data['precio_venta_producto']
                            .replace("Q./ ", "")).toFixed(2);
                        NuevoPrecio = "Q./ " + NuevoPrecio;
                        table.cell(index, 7).data(NuevoPrecio).draw();
                ...
                if (respuesta['aplica_peso'] == 1) {
                    ...
                    table.row.add({
                        ...
                        'acciones': "<center>" +
                            ...
                            "' style='cursor:pointer; font-size:14px;'>Por Mayor (Q./ " +
    ...
    if (count > 0) {
        ...
        if ($("#iptEfectivoRecibido").val() > 0 && $("#iptEfectivoRecibido").val() != "") {
            ...
            table.rows().eq(0).each(function(index) {
                ...
                arr[index] = data['codigo_producto'] + "," + parseFloat(data['cantidad']) + "," + data['total']
                    .replace("Q./ ", "");
