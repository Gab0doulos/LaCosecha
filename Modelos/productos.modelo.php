...
//manipulacion y lectura de las hojas de excel
...
class ProductosModelo{
    ...
    // resgistrar productos uno a uno desde el formulario del inventario
    ...
    /*Listar nombre productos para input de auto completado*/
    static public function mdlListarNombreProductos(){
        $stmt = Conexion::conectar()->prepare("SELECT Concat(codigo_producto , ' - ', c.nombre_categoria, ' - ', descripcion_producto, ' - Q./ ', p.precio_venta_producto) 
